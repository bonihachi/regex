...
#[derive(Debug)]
pub enum ParseError {
    InvalidEscape(usize, char), // Wrong escape sequence
    InvalidRightParen(usize),   // No right parenthesis
    NoPrev(usize),              // No expression before +, |, *, or ?
    NoRightParen,               // No left parenthesis
    Empty,                      // Empty pattern
}
